...
- `string` - type alias for `char*`, `null`-terminated (may move to pointer+length model later)
...
### Safety attributes
- `@null` - compiler inserts runtime null checks when dereferencing the annotated value
